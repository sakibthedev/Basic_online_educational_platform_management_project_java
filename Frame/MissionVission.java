...
public class MissionVission extends JFrame implements MouseListener,ActionListener{
	
	JPanel panel;
	JLabel name,PICTURE,C1,C2,C3,line1,line2,line3,box;
	...
	public MissionVission(String dpName){
	
	super("Mission and Vision");
	...
	C1=new JLabel("Empowering human potential");
	C1.setBounds(400,90,580,122);
	C1.setForeground(col);
	C1.setFont(new Font("Ariel",Font.PLAIN,37));
	panel.add(C1);
	
	C2=new JLabel("one student at a time!");
	C2.setBounds(400,120,580,142);
	C2.setForeground(col);
	C2.setFont(new Font("Ariel",Font.BOLD,37));
	panel.add(C2);
	
	C3=new JLabel("Our Mission & Vision");
	C3.setBounds(742,395,325,43);
	C3.setForeground(col);
	C3.setFont(new Font("Ariel",Font.BOLD,26));
	panel.add(C3);
	
	PICTURE = new JLabel(picture);
	PICTURE.setBounds(100,241,577,433);
	PICTURE.setBackground(Color.WHITE);
	PICTURE.setOpaque(true);
	panel.add(PICTURE);
	
	line1=new JLabel("To deliver impact—each day, every day—as");
	line1.setBounds(742,406,451,133);
	line1.setFont(new Font("Ariel",Font.PLAIN,23));
	line1.setForeground(Color.BLACK);
	panel.add(line1);
	
	line2=new JLabel("we develop a fair and inclusive learning");
	line2.setBounds(742,436,451,133);
	line2.setFont(new Font("Ariel",Font.PLAIN,23));
	line2.setForeground(Color.BLACK);
	panel.add(line2);
	
	line3=new JLabel("space for everyone.");
	line3.setBounds(742,466,451,133);
	line3.setFont(new Font("Ariel",Font.PLAIN,23));
	line3.setForeground(Color.BLACK);
	panel.add(line3);
	
	box= new JLabel();
	box.setBounds(727,440,479,120);
