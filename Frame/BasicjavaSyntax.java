...
public class BasicjavaSyntax extends JFrame implements MouseListener,ActionListener{
	
	JPanel panel;
	
	ImageIcon logo, user,jpic1,jpic2, Navigation;
	JButton sub, skills, about, USER, LOGO;
	JLabel name,shape5, shape6, shape7, C1,line1,line2,line3,line4,line5,line6,line7,line8,line9,line10,line11,line12,line13,box,navigation;
	...
	public BasicjavaSyntax(String dpName){
	...
	line1=new JLabel("public class Main {");
	line1.setBounds(449,250,488,180);
	line1.setFont(new Font("Ariel",Font.BOLD,26));
	line1.setForeground(Color.BLACK);
	panel.add(line1);
	
	
	line2=new JLabel("  public static void main(String[ ] args){");
	line2.setBounds(449,290,488,180);
	line2.setFont(new Font("Ariel",Font.BOLD,26));
	line2.setForeground(Color.BLACK);
	panel.add(line2);
	
	line3=new JLabel("    System.out.println(Hello World);");
	line3.setBounds(449,330,488,180);
	line3.setFont(new Font("Ariel",Font.BOLD,26));
	line3.setForeground(Color.BLACK);
	panel.add(line3);
	
	line4=new JLabel("  }");
	line4.setBounds(449,370,488,180);
	line4.setFont(new Font("Ariel",Font.BOLD,26));
	line4.setForeground(Color.BLACK);
	panel.add(line4);
	
	line5=new JLabel("}");
	line5.setBounds(449,410,488,180);
	line5.setFont(new Font("Ariel",Font.BOLD,26));
