...
public class PaymentEnglish extends JFrame implements MouseListener,ActionListener{
	...
	public PaymentEnglish(String dpName){
	...
	courPic = new ImageIcon("Image/Basic English.jpg");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			BasicEnglish course1 = new BasicEnglish(dpName);
			course1.setVisible(true);
			this.setVisible(false);
		}
		else if(ae.getSource()==pay)
		{
			String courseName = "Course Name: English"; 
			String amount = "6000/-"; 
