...
public class JavaComments extends JFrame implements MouseListener,ActionListener{
	...
	public JavaComments(String dpName){
	...
	line1=new JLabel("Single-line comments start with two forward slashes (//).");
	line1.setBounds(449,215,740,180);
	line1.setFont(new Font("Ariel",Font.BOLD,26));
	line1.setForeground(Color.BLACK);
	panel.add(line1);

	line2=new JLabel("Multi-line comments start with /* and ends with */");
	line2.setBounds(449,215+40,740,180);
	line2.setFont(new Font("Ariel",Font.BOLD,26));
	line2.setForeground(Color.BLACK);
	panel.add(line2);

	line3=new JLabel("// This is a comment");
	line3.setBounds(449,215+40+30+40,740,180);
	line3.setFont(new Font("Ariel",Font.PLAIN,26));
	line3.setForeground(Color.BLACK);
	panel.add(line3);

	line4=new JLabel("System.out.println(\"Hello World\");");
	line4.setBounds(449,215+40+30+40+40,740,180);
	line4.setFont(new Font("Ariel",Font.PLAIN,26));
	line4.setForeground(Color.BLACK);
	panel.add(line4);

	line5=new JLabel("/* The code below will print the words Hello World");
	line5.setBounds(449,215+40+40+30+30+40+40,740,180);
	line5.setFont(new Font("Ariel",Font.PLAIN,26));
	line5.setForeground(Color.BLACK);
	panel.add(line5);

	line5=new JLabel("to the screen, and it is amazing */");
	line5.setBounds(449,215+40+40+30+30+40+40+40,740,180);
	line5.setFont(new Font("Ariel",Font.PLAIN,26));
	line5.setForeground(Color.BLACK);
	panel.add(line5);

	line6=new JLabel("System.out.println(\"Hello World\");");
	line6.setBounds(449,215+40+40+40+30+30+40+40+40,740,180);
	line6.setFont(new Font("Ariel",Font.PLAIN,26));
