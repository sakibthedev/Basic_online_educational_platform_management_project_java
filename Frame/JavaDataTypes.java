...
public class JavaDataTypes extends JFrame implements MouseListener,ActionListener{
	...
	public JavaDataTypes(String dpName){
	
	super("Java Data Types");
	...
	line7=new JLabel("String myText = \"Hello\"; ");
