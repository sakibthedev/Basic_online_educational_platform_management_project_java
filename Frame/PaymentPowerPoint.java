...
public class PaymentPowerPoint extends JFrame implements MouseListener,ActionListener{
	...
	public PaymentPowerPoint(String dpName){
	...
	courPic = new ImageIcon("Image/PowerPoint.png");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			MSPowerPoint course1 = new MSPowerPoint(dpName);
			course1.setVisible(true);
			this.setVisible(false);
		}
		else if(ae.getSource()==pay)
		{
			String courseName = "Course Name: Powerpoint"; 
			String amount = "3000/-"; 

			JOptionPane.showMessageDialog(this, "Payment Successful!");
    
			PaymentHistory.addPayment(courseName, amount); // Save payment to history
