...
public class PaymentIllustrator extends JFrame implements MouseListener,ActionListener{
	...
	public PaymentIllustrator(String dpName){
	...
	courPic = new ImageIcon("Image/Illustrator.png");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			Illustrator course1 = new Illustrator(dpName);
			course1.setVisible(true);
			this.setVisible(false);
		}
		else if(ae.getSource()==pay)
		{
			String courseName = "Course Name: Illustrator"; 
			String amount = "3000/-"; 
