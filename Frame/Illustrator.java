...
public class Illustrator extends JFrame implements MouseListener,ActionListener{
	
	JPanel panel;
	JLabel name,title, line1, box1, box2, box3, box4, box5, box6, box7, box8, PICTURE;
	JLabel chapter, video, design, live, quiz, certificate, price, enStart, txt1, txt2, txt3, txt4, txt5, txt6, txt7, txt8;
	...
	public Illustrator(String dpName){
	...
	title = new JLabel("Illustrator");
	title.setBounds(149,214,332,61);
	title.setForeground(color2);
	title.setFont(new Font("Ariel",Font.BOLD,40));
	panel.add(title);
	
	line1 = new JLabel("Showcase Your Design Skills To");
	line1.setBounds(149, 275, 500, 33);
	line1.setForeground(Color.BLACK);
	line1.setFont(font4);
	panel.add(line1);
	
	line1 = new JLabel("The Modern World!");
	line1.setBounds(149, 308, 250, 33);
	line1.setForeground(Color.BLACK);
	line1.setFont(font4);
	panel.add(line1);
	...
	design = new JLabel("Total Design");
	design.setBounds(173, 479, 142, 32);
	design.setForeground(color2);
	design.setFont(font3);
	panel.add(design);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(ae.getSource()==enroll)
		{
			...
			if(choice==0)
			{
				PaymentIllustrator p1 = new PaymentIllustrator(dpName);
				p1.setVisible(true);
				this.setVisible(false);
			}
		}
