...
public class MSPowerPoint extends JFrame implements MouseListener,ActionListener{
	
	JPanel panel;
	JLabel name,title, line1, box1, box2, box3, box4, box5, box6, box7, box8, PICTURE;
	JLabel chapter, video, preset, live, quiz, certificate, price, enStart, txt1, txt2, txt3, txt4, txt5, txt6, txt7, txt8;
	...
	public MSPowerPoint(String dpName){
	...
	title = new JLabel("MS PowerPoint");
	title.setBounds(149,214,332,61);
	title.setForeground(new Color(211, 82, 49));
	title.setFont(new Font("Ariel",Font.BOLD,40));
	panel.add(title);
	
	line1 = new JLabel("Showcase Your PowerPoint Skills");
	line1.setBounds(149, 275, 500, 33);
	line1.setForeground(Color.BLACK);
	line1.setFont(font4);
	panel.add(line1);
	
	line1 = new JLabel("To The World!");
	line1.setBounds(149, 308, 200, 33);
	line1.setForeground(Color.BLACK);
	line1.setFont(font4);
	panel.add(line1);
	...
	txt2 = new JLabel("10 hours");
	txt2.setBounds(379, 425, 97, 32);
	...
	preset = new JLabel("Presentation");
	preset.setBounds(173, 479, 142, 32);
	preset.setForeground(color2);
	preset.setFont(font3);
	panel.add(preset);
	
	txt3 = new JLabel("10");
	txt3.setBounds(223, 516, 28, 32);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(ae.getSource()==enroll)
		{
			...
			if(choice==0)
			{
				PaymentPowerPoint p1 = new PaymentPowerPoint(dpName);
				p1.setVisible(true);
				this.setVisible(false);
			}
		}
