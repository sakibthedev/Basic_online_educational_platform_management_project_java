...
public class JoinWithUs extends JFrame implements MouseListener,ActionListener{
	
	JPanel panel;
	JLabel name,C1,C2,C3,PICTURE,line1,line2,line3,line4,line5,line6,box1,box2,box3;
	...
	public JoinWithUs(String dpName){
	...
	picture = new ImageIcon("Image/pic3.png");
	...
	C1=new JLabel("Turning dreams into reality");
	C1.setBounds(388,116,622,122);
	C1.setForeground(col);
	C1.setFont(new Font("Ariel",Font.PLAIN,40));
	panel.add(C1);
	
	C2=new JLabel("through the strength of learning!");
	C2.setBounds(388,156,622,136);
	C2.setForeground(col);
	C2.setFont(new Font("Ariel",Font.BOLD,40));
	panel.add(C2);
	
	C3=new JLabel("Why partner with us?");
	C3.setBounds(168,279,332,43);
	C3.setForeground(col);
	C3.setFont(new Font("Ariel",Font.BOLD,30));
	panel.add(C3);
	
	PICTURE = new JLabel(picture);
	PICTURE.setBounds(690,246,613,409);
	PICTURE.setBackground(Color.WHITE);
	PICTURE.setOpaque(true);
	panel.add(PICTURE);
	
	line1=new JLabel("Imagine");
	line1.setBounds(297,341,127,43);
	line1.setFont(new Font("Ariel",Font.BOLD,30));
	line1.setForeground(col);
	panel.add(line1);
	
	line2=new JLabel("the evolution of education");
	line2.setBounds(235,384,251,32);
	line2.setFont(new Font("Ariel",Font.PLAIN,24));
	line2.setForeground(Color.BLACK);
	panel.add(line2);
	
	box1= new JLabel();
	box1.setBounds(168,336,384,96);
	box1.setBackground(new Color(246,246,246));
	box1.setOpaque(true);
	panel.add(box1);
	
	line3=new JLabel("Empower");
	line3.setBounds(307,451,104,43);
	line3.setFont(new Font("Ariel",Font.BOLD,30));
	line3.setForeground(col);
	panel.add(line3);
	
	line4=new JLabel("entry to superior learning");
	line4.setBounds(214,494,294,32);
	line4.setFont(new Font("Ariel",Font.PLAIN,24));
	line4.setForeground(Color.BLACK);
	panel.add(line4);
	
	box2= new JLabel();
	box2.setBounds(167,446,384,96);
	box2.setBackground(new Color(246,246,246));
	box2.setOpaque(true);
	panel.add(box2);
	
	line5=new JLabel("Imagine");
	line5.setBounds(296,561,127,43);
	line5.setFont(new Font("Ariel",Font.BOLD,30));
	line5.setForeground(col);
	panel.add(line5);
	
	line6=new JLabel("the academic ecosystem");
	line6.setBounds(212,607,294,32);
	line6.setFont(new Font("Ariel",Font.PLAIN,24));
	line6.setForeground(Color.BLACK);
	panel.add(line6);
	
	box3= new JLabel();
	box3.setBounds(167,556,384,96);
