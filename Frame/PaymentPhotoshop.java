...
public class PaymentPhotoshop extends JFrame implements MouseListener,ActionListener{
	...
	public PaymentPhotoshop(String dpName){
	...
	courPic = new ImageIcon("Image/Photoshop.png");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			Photoshop course1 = new Photoshop(dpName);
			course1.setVisible(true);
			this.setVisible(false);
		}
		else if(ae.getSource()==pay)
		{
			String courseName = "Course Name: Photoshop"; 
			String amount = "5000/-"; 
