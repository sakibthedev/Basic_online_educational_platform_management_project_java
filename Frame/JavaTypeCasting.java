...
public class JavaTypeCasting extends JFrame implements MouseListener,ActionListener{
	
	JPanel panel;
	
	ImageIcon logo, user,jpic1,jpic2, Navigation;
	JButton sub, skills, about, USER, LOGO;
	JLabel name,shape5, shape6, shape7, C1, line1, line2, line3, line4, line5, line6, line7, text1, text2, text3, text4, text5, text6, text7,box,navigation;
	JButton bCpp, bJava, bInt, bEng, bMSP, bIllustrator, bFigma, bPhotoshop, bWhatSkillPros, bOurMV, bWhyJoin,b1,b2,b3,b4,b5,b6,b7,b8;
	Font font1, font2, font3, font4, font5;
	Color c1;
	public String dpName;
	
	public JavaTypeCasting(String dpName){
	
	super("Java Type Casting");
	...
	C1 = new JLabel("Java Type Casting");
	C1.setBounds(443,216,371,61);
	C1.setForeground(c1);
	C1.setFont(new Font("Ariel",Font.BOLD,40));
	panel.add(C1);
	
	
	line1=new JLabel("In Java, there are two types of casting");
	line1.setBounds(449,215,600,180);
	line1.setFont(new Font("Ariel",Font.PLAIN,26));
	line1.setForeground(Color.BLACK);
	panel.add(line1);

	line2=new JLabel("   1. Explicit Type Casting");
	line2.setBounds(449,215+40,740,180);
	line2.setFont(new Font("Ariel",Font.PLAIN,26));
	line2.setForeground(Color.BLACK);
	panel.add(line2);

	line3=new JLabel("   2. Implicit Type Casting");
	line3.setBounds(449,215+40+40,740,180);
	line3.setFont(new Font("Ariel",Font.PLAIN,26));
	line3.setForeground(Color.BLACK);
	panel.add(line3);

	line4=new JLabel("1. Explicit Casting (automatically) - converting a smaller type to a larger type size");
	line4.setBounds(449,215+40+40+40+40,740,180);
	line4.setFont(new Font("Ariel",Font.PLAIN,19));
	line4.setForeground(Color.BLACK);
	panel.add(line4);

	line5=new JLabel("byte -> short -> char -> int -> long -> float -> double");
	line5.setBounds(449,215+40+40+40+40+40,740,180);
	line5.setFont(new Font("Ariel",Font.PLAIN,19));
	line5.setForeground(Color.BLACK);
	panel.add(line5);

	line6=new JLabel("2. Implicit Casting (manually) - converting a larger type to a smaller size type");
	line6.setBounds(449,215+40+40+40+40+40+40,740,180);
	line6.setFont(new Font("Ariel",Font.PLAIN,19));
	line6.setForeground(Color.BLACK);
	panel.add(line6);

	line7=new JLabel("double -> float -> long -> int -> char -> short -> byte");
	line7.setBounds(449,215+40+40+40+40+40+40+40,740,180);
	line7.setFont(new Font("Ariel",Font.PLAIN,19));
	line7.setForeground(Color.BLACK);
	panel.add(line7);

	box= new JLabel();
	box.setBounds(449,331,488,180);
	box.setBackground(Color.WHITE);
	box.setOpaque(true);
	panel.add(box);
		
	line6=new JLabel("What is Java?");
	line6.setBounds(101,232,227,41);
	line6.setFont(new Font("Ariel",Font.BOLD,22));
	line6.setForeground(Color.BLACK);
	panel.add(line6);
	...
	text1=new JLabel("Why Use Java?");
	text1.setBounds(101,283,227,41);
	text1.setFont(new Font("Ariel",Font.BOLD,22));
	text1.setForeground(Color.BLACK);
	panel.add(text1);
	
	b2=new JButton(jpic1);
	...
	panel.add(b2);
	 ...
	 text2=new JLabel("Basic Java Syntax");
	 text2.setBounds(101,333,227,41);
	 text2.setFont(new Font("Ariel",Font.BOLD,22));
	...
	panel.add(b3);
	 ...
	 text3=new JLabel("Java Output");
	 text3.setBounds(101,383,227,41);
	 text3.setFont(new Font("Ariel",Font.BOLD,22));
	...
	panel.add(b4);
	 ...
	 text4=new JLabel("Java Comments");
	 text4.setBounds(101,433,227,41);
	 text4.setFont(new Font("Ariel",Font.BOLD,22));
	...
	text5=new JLabel("Java Variables");
	text5.setBounds(101,483,227,41);
	text5.setFont(new Font("Ariel",Font.BOLD,22));
	...
	text6=new JLabel("Java Data Types");
	text6.setBounds(101,533,227,41);
	text6.setFont(new Font("Ariel",Font.BOLD,22));
	...
	text7=new JLabel("Java Type Casting");
	text7.setBounds(101,583,227,41);
	text7.setFont(new Font("Ariel",Font.BOLD,22));
	text7.setForeground(Color.WHITE);
	panel.add(text7);
	
	b8=new JButton(jpic2);
