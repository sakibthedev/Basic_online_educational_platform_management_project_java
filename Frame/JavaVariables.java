...
public class JavaVariables extends JFrame implements MouseListener,ActionListener{
	...
	public JavaVariables(String dpName){
	
	super("Java Variables");
	...
	line1=new JLabel("Variables are containers for storing data values.");
	line1.setBounds(449,215,600,180);
	line1.setFont(new Font("Ariel",Font.PLAIN,26));
	line1.setForeground(Color.BLACK);
	panel.add(line1);

	line2=new JLabel("In Java, there are different types of variables, for example:");
	line2.setBounds(449,215+40,740,180);
	line2.setFont(new Font("Ariel",Font.PLAIN,26));
	line2.setForeground(Color.BLACK);
	panel.add(line2);

	line3=new JLabel("   1. String - stores text");
	line3.setBounds(449,215+40+40,740,180);
	line3.setFont(new Font("Ariel",Font.PLAIN,26));
	line3.setForeground(Color.BLACK);
	panel.add(line3);

	line4=new JLabel("   2. int - stores integers (whole numbers)");
	line4.setBounds(449,215+40+40+40,740,180);
	line4.setFont(new Font("Ariel",Font.PLAIN,26));
	line4.setForeground(Color.BLACK);
	panel.add(line4);

	line5=new JLabel("   3. float - stores floating point numbers");
	line5.setBounds(449,215+40+40+40+40,740,180);
	line5.setFont(new Font("Ariel",Font.PLAIN,26));
	line5.setForeground(Color.BLACK);
	panel.add(line5);

	line6=new JLabel("   4. char - stores single characters");
	line6.setBounds(449,215+40+40+40+40+40,740,180);
	line6.setFont(new Font("Ariel",Font.PLAIN,26));
	line6.setForeground(Color.BLACK);
	panel.add(line6);

	line7=new JLabel("   5. boolean - stores values with two states: true or false");
	line7.setBounds(449,215+40+40+40+40+40+40,740,180);
	line7.setFont(new Font("Ariel",Font.PLAIN,26));
