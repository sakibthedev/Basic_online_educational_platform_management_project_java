...
public class BasicEnglish extends JFrame implements MouseListener,ActionListener{
	...
	public BasicEnglish(String dpName){
	...
	txt1 = new JLabel("English");
	txt1.setBounds(149, 214-20, 278+30, 61);
	txt1.setFont(font3);
	txt1.setForeground(new Color(139,7,38));
	panel.add(txt1);

	txt2 = new JLabel("Stay connected to the modern world");
	txt2.setBounds(149, 275-45, 547+100, 86);
	txt2.setFont(font4);
	txt2.setForeground(Color.BLACK);
	panel.add(txt2);
	txt2A = new JLabel("through English");
	...
	txt3.setFont(font5);
	txt3.setForeground(new Color(139,7,38));
	panel.add(txt3);
	...
	txt5.setFont(font5);
	txt5.setForeground(new Color(139,7,38));
	panel.add(txt5);
	...
	txt7.setFont(font5);
	txt7.setForeground(new Color(139,7,38));
	panel.add(txt7);
	...
	txt9.setFont(font5);
	txt9.setForeground(new Color(139,7,38));
	panel.add(txt9);
	...
	txt11.setFont(font5);
	txt11.setForeground(new Color(139,7,38));
	panel.add(txt11);
	...
	txt12.setFont(font5);
	txt12.setForeground(new Color(139,7,38));
	panel.add(txt12);
	...
	txt14.setFont(font4);
	txt14.setForeground(new Color(139,7,38));
	panel.add(txt14);

	txt15 = new JLabel("6000/-");
	...
	txt16.setFont(font5);
	txt16.setForeground(new Color(139,7,38));
	panel.add(txt16);

	txt17 = new JLabel("5 May, 2025");
	...
	enroll.setBackground(new Color(139,7,38));
	...
	ImageIcon customImage = new ImageIcon("Image/Basic English.jpg");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(ae.getSource()==enroll)
		{
			...
			if(choice==0)
			{
				PaymentEnglish p1 = new PaymentEnglish(dpName);
				p1.setVisible(true);
				this.setVisible(false);
			}
		}
