...
public class BasicIntegration extends JFrame implements MouseListener,ActionListener{
	
	JPanel panel;
	JLabel name, txt1, txt2, txt2A, txt3, txt4, txt5, txt6, txt7, txt8, txt9, txt10, txt11, txt12, txt13, txt14, txt15, txt16, txt17,
	...
	public BasicIntegration(String dpName){
	...
	txt1 = new JLabel("Integration");
	txt1.setBounds(149, 214-20, 278+100, 61);
	txt1.setFont(font3);
	txt1.setForeground(new Color(12,100,109));
	panel.add(txt1);

	txt2 = new JLabel("Enhance your problem-solving skills");
	txt2.setBounds(149, 275-45, 547+100, 86);
	txt2.setFont(font4);
	txt2.setForeground(Color.BLACK);
	panel.add(txt2);
	txt2A = new JLabel("through Integration");
	txt2A.setBounds(149, 275-10, 547, 86);
	txt2A.setFont(font4);
	txt2A.setForeground(Color.BLACK);
	panel.add(txt2A);
	...
	txt3.setFont(font5);
	txt3.setForeground(new Color(12,100,109));
	panel.add(txt3);
	...
	txt5.setFont(font5);
	txt5.setForeground(new Color(12,100,109));
	panel.add(txt5);

	txt6 = new JLabel("60 hours");
	...
	txt7.setFont(font5);
	txt7.setForeground(new Color(12,100,109));
	panel.add(txt7);

	txt8 = new JLabel("1000");
	txt8.setBounds(214,481,51,32);
	txt8.setFont(font5);
	...
	txt9.setFont(font5);
	txt9.setForeground(new Color(12,100,109));
	panel.add(txt9);
	...
	txt11 = new JLabel("Quiz");
	txt11.setBounds(196+20,535,87,32);
	txt11.setFont(font5);
	txt11.setForeground(new Color(12,100,109));
	panel.add(txt11);
	...
	txt12.setFont(font5);
	txt12.setForeground(new Color(12,100,109));
	panel.add(txt12);
	...
	txt14.setFont(font4);
	txt14.setForeground(new Color(12,100,109));
	panel.add(txt14);

	txt15 = new JLabel("7000/-");
	...
	txt16.setFont(font5);
	txt16.setForeground(new Color(12,100,109));
	panel.add(txt16);

	txt17 = new JLabel("1 June, 2025");
	txt17.setBounds(985+25,529,161,32);
	txt17.setFont(font5);
	...
	enroll.setBackground(new Color(12,100,109));
	...
	ImageIcon customImage = new ImageIcon("Image/Basic integration.png");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(ae.getSource()==enroll)
		{
			...
			if(choice==0)
			{
				PaymentIntegration p1 = new PaymentIntegration(dpName);
				p1.setVisible(true);
				this.setVisible(false);
			}
		}
