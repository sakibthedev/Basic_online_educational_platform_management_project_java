...
public class JavaOutput extends JFrame implements MouseListener,ActionListener{
	
	JPanel panel;
	
	ImageIcon logo, user,jpic1,jpic2, Navigation;
	JButton sub, skills, about, USER, LOGO;
	JLabel name,shape5, shape6, shape7,C1,line1,line2,line3,line4,line5,line6,line7,line8,line9,line10,line11,line12,line13,navigation;
	...
	public JavaOutput(String dpName){
	...
	C1 = new JLabel("Java Output");
	C1.setBounds(447,222,255,61);
	C1.setForeground(c1);
	C1.setFont(new Font("Ariel",Font.BOLD,40));
	panel.add(C1);
	
	
	line1=new JLabel("You can add as many println() methods as you want.");
	line1.setBounds(436,300,673,36);
	line1.setFont(new Font("Ariel",Font.BOLD,24));
	line1.setForeground(Color.BLACK);
	panel.add(line1);
	
	line2=new JLabel("Note that it will add a new line for each method:");
	line2.setBounds(436,334,624,36);
	line2.setFont(new Font("Ariel",Font.BOLD,24));
	line2.setForeground(Color.BLACK);
	panel.add(line2);
	
	line3=new JLabel("  System.out.println(\"Hello World\");");
	line3.setBounds(436,398,624,36);
	line3.setFont(new Font("Ariel",Font.PLAIN,24));
	line3.setForeground(Color.BLACK);
	panel.add(line3);
	
	
	line4=new JLabel("  System.out.println(\"I am learning Java.\");");
	line4.setBounds(436,428,624,36);
	line4.setFont(new Font("Ariel",Font.PLAIN,24));
	line4.setForeground(Color.BLACK);
	panel.add(line4);
	
	line5=new JLabel("  System.out.println(\"It is awesome\");");
	line5.setBounds(436,458,624,36);
	line5.setFont(new Font("Ariel",Font.PLAIN,24));
	...
	line7=new JLabel("Why Use Java?");
	line7.setBounds(101,283,227,41);
	line7.setFont(new Font("Ariel",Font.BOLD,22));
	...
	line8=new JLabel("Basic Java Syntax");
	line8.setBounds(101,333,227,41);
	...
	line9=new JLabel("Java Output");
	line9.setBounds(101,383,227,41);
	line9.setFont(new Font("Ariel",Font.BOLD,22));
	line9.setForeground(Color.WHITE);
	panel.add(line9);
	
	b4=new JButton(jpic2);
	...
	line10=new JLabel("Java Comments");
	line10.setBounds(101,433,227,41);
	...
	line11=new JLabel("Java Variables");
	line11.setBounds(101,483,227,41);
	...
	line12=new JLabel("Java Data Types");
	line12.setBounds(101,533,227,41);
	...
	line13=new JLabel("Java Type Casting");
	line13.setBounds(101,583,227,41);
