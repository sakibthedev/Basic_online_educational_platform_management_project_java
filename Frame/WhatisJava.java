...
public class WhatisJava extends JFrame implements MouseListener,ActionListener{
	
	JPanel panel;
	
	ImageIcon logo, user,jpic1,jpic2, Navigation;
	JButton sub, skills, about, USER, LOGO;
	JLabel name,shape5, shape6, shape7,C1,line1,line2,line3,line4,line5,line6,line7,line8,line9,line10,line11,line12,line13,line14,line15,line16,line17,line18,box,navigation;
	...
	public WhatisJava(String dpName){
	...
	C1 = new JLabel("What is Java?");
	C1.setBounds(443,216,283,61);
	C1.setForeground(c1);
	C1.setFont(new Font("Ariel",Font.BOLD,40));
	panel.add(C1);
	
	
	line1=new JLabel("Java is a popular programming language,created in 1995.");
	line1.setBounds(443,260,624,50);
	line1.setFont(new Font("Ariel",Font.PLAIN,22));
	line1.setForeground(Color.BLACK);
	panel.add(line1);
	
	line2=new JLabel("It is owned by Oracle, and more than 3 billion devices run Java.");
	line2.setBounds(443,290,624,50);
	line2.setFont(new Font("Ariel",Font.PLAIN,22));
	line2.setForeground(Color.BLACK);
	panel.add(line2);
	
	line3=new JLabel("It is used:");
	line3.setBounds(443,320,624,50);
	line3.setFont(new Font("Ariel",Font.PLAIN,22));
	line3.setForeground(Color.BLACK);
	panel.add(line3);
	
	
	line4=new JLabel("1.Mobile applications(specially Android apps)");
	line4.setBounds(446,350,624,50);
	line4.setFont(new Font("Ariel",Font.PLAIN,22));
	line4.setForeground(Color.BLACK);
	panel.add(line4);
	
	line5=new JLabel("2.Desktop applications");
	line5.setBounds(446,380,624,50);
	line5.setFont(new Font("Ariel",Font.PLAIN,22));
	line5.setForeground(Color.BLACK);
	panel.add(line5);
	
	line6=new JLabel("3.Web applications");
	line6.setBounds(446,410,624,50);
	line6.setFont(new Font("Ariel",Font.PLAIN,22));
	line6.setForeground(Color.BLACK);
	panel.add(line6);
	
	
	line7=new JLabel("4.Web servers and application servers");
	line7.setBounds(446,440,624,50);
	line7.setFont(new Font("Ariel",Font.PLAIN,22));
	line7.setForeground(Color.BLACK);
	panel.add(line7);
	
	line8=new JLabel("5.Game");
	line8.setBounds(446,470,624,50);
	line8.setFont(new Font("Ariel",Font.PLAIN,22));
	line8.setForeground(Color.BLACK);
	panel.add(line8);
	
	
	line9=new JLabel("6.Database connection");
	line9.setBounds(446,500,624,50);
	line9.setFont(new Font("Ariel",Font.PLAIN,22));
	line9.setForeground(Color.BLACK);
	panel.add(line9);
	
	line10=new JLabel("7.And much, much more!");
	line10.setBounds(446,530,624,50);
	line10.setFont(new Font("Ariel",Font.PLAIN,22));
	...
	line11=new JLabel("What is Java?");
	line11.setBounds(101,232,227,41);
	line11.setFont(new Font("Ariel",Font.BOLD,22));
	line11.setForeground(Color.WHITE);
	panel.add(line11);
	
	b1=new JButton(jpic2);
	...
	line12=new JLabel("Why Use Java?");
	line12.setBounds(101,283,227,41);
	...
	line13=new JLabel("Basic Java Syntax");
	line13.setBounds(101,333,227,41);
	...
	line14=new JLabel("Java Output");
	line14.setBounds(101,383,227,41);
	...
	line15=new JLabel("Java Comments");
	line15.setBounds(101,433,227,41);
	...
	line16=new JLabel("Java Variables");
	line16.setBounds(101,483,227,41);
	line16.setFont(new Font("Ariel",Font.BOLD,22));
	...
	line17=new JLabel("Java Data Types");
	line17.setBounds(101,533,227,41);
	line17.setFont(new Font("Ariel",Font.BOLD,22));
	...
	line18=new JLabel("Java Type Casting");
	line18.setBounds(101,583,227,41);
	line18.setFont(new Font("Ariel",Font.BOLD,22));
