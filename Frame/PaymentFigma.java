...
public class PaymentFigma extends JFrame implements MouseListener,ActionListener{
	...
	public PaymentFigma(String dpName){
	...
	courPic = new ImageIcon("Image/Figma.png");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			Figma course1 = new Figma(dpName);
			course1.setVisible(true);
			this.setVisible(false);
		}
		else if(ae.getSource()==pay)
		{
			String courseName = "Course Name: Figma"; 
			String amount = "3000/-"; 
