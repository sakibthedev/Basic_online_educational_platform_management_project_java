...
public class BasicCPP extends JFrame implements MouseListener,ActionListener{
	...
	txt1.setFont(font3);
	txt1.setForeground(new Color(46, 16, 243));
	panel.add(txt1);

	txt2 = new JLabel("Build your first program with C++");
	...
	txt3.setFont(font5);
	txt3.setForeground(new Color(46, 16, 243));
	panel.add(txt3);
	...
	txt5.setFont(font5);
	txt5.setForeground(new Color(46, 16, 243));
	panel.add(txt5);

	txt6 = new JLabel("45 hours");
	...
	txt7.setFont(font5);
	txt7.setForeground(new Color(46, 16, 243));
	panel.add(txt7);
	...
	txt9.setFont(font5);
	txt9.setForeground(new Color(46, 16, 243));
	panel.add(txt9);
	...
	txt11.setFont(font5);
	txt11.setForeground(new Color(46, 16, 243));
	panel.add(txt11);
	...
	txt12.setFont(font5);
	txt12.setForeground(new Color(46, 16, 243));
	panel.add(txt12);
	...
	txt14.setFont(font4);
	txt14.setForeground(new Color(46, 16, 243));
	panel.add(txt14);

	txt15 = new JLabel("7500/-");
	...
	txt16.setFont(font5);
	txt16.setForeground(new Color(46, 16, 243));
	panel.add(txt16);

	txt17 = new JLabel("8 July, 2025");
	...
	enroll.setBackground(new Color(46, 16, 243));
	...
	ImageIcon customImage = new ImageIcon("Image/Basic CPP.png");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(ae.getSource()==enroll)
		{
			...
			if(choice==0)
			{
				PaymentCpp p1 = new PaymentCpp(dpName);
				p1.setVisible(true);
				this.setVisible(false);
			}
		}
