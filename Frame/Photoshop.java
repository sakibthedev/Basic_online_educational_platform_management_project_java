...
public class Photoshop extends JFrame implements MouseListener,ActionListener{
	...
	public Photoshop(String dpName){
	...
	color2 = new Color(54, 166, 250);
	color3 = new Color(45,69,255);
	
	
	logo = new ImageIcon("Image/Logo.png");
	user = new ImageIcon("Image/User.png");
	picture = new ImageIcon("Image/Photoshop.png");
	...
	title = new JLabel("Photoshop");
	title.setBounds(149,214,332,61);
	title.setForeground(color2);
	title.setFont(new Font("Ariel",Font.BOLD,40));
	panel.add(title);
	
	line1 = new JLabel("Unlock the Power of Photoshop:");
	line1.setBounds(149, 275, 500, 33);
	line1.setForeground(Color.BLACK);
	line1.setFont(font4);
	panel.add(line1);
	
	line1 = new JLabel("Learn, Create, Inspire");
	line1.setBounds(149, 308, 300, 33);
	line1.setForeground(Color.BLACK);
	line1.setFont(font4);
	panel.add(line1);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(ae.getSource()==enroll)
		{
			...
			if(choice==0)
			{
				PaymentPhotoshop p1 = new PaymentPhotoshop(dpName);
				p1.setVisible(true);
				this.setVisible(false);
			}
		}
