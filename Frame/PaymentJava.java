...
public class PaymentJava extends JFrame implements MouseListener,ActionListener{
	...
	public PaymentJava(String dpName){
	...
	courPic = new ImageIcon("Image/Basic Java.png");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			BasicJava course1 = new BasicJava(dpName);
		...
		else if(ae.getSource()==pay)
		{
			...
			WhatisJava wj1 = new WhatisJava(dpName);
			wj1.setVisible(true);
			this.setVisible(false);
		}
	}
